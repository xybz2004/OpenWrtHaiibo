...
- 固件集成的所有 ipk 插件全部打包在 Packages 文件中，可以在 [Releases](https://github.com/xybz2004/OpenWrt/releases) 内进行下载
...
6. 编译大概需要3-5小时，编译完成后在仓库主页 [Releases](https://github.com/xybz2004/OpenWrt/releases) 对应 Tag 标签内下载固件
<details>
